...
public class DbContextCollectionGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        foreach (var collection in csr.Collections)
        {
            ...
            var item = new DataCollection(className, ModifyName(className), GetNamespace(collection));
            list.Add(item);
            GenerateExtensionClass(context, item.ClassName, item.Name, item.Namespace);
        }
...
";
    ...
    static void GenerateContext(GeneratorExecutionContext context, List<DataCollection> list)
    {
        ...
        foreach (var (className, name, @namespace) in list)
        {
    ...
    static void GenerateExtensionClass(GeneratorExecutionContext context, string className, string name, string @namespace)
    {
...
{{
    ...
    public static {fullName} LoadRecordById(this MongoDbContextCollection<{fullName}> collection, Guid id)
    {{
        var filter = Builders<{fullName}>.Filter.Eq(""Id"", id);
        return collection.LoadRecordBy(filter);
    }}
    public static Task<{fullName}> LoadRecordByIdAsync(this MongoDbContextCollection<{fullName}> collection, Guid id)
    {{
        var filter = Builders<{fullName}>.Filter.Eq(""Id"", id);
        return collection.LoadRecordByAsync(filter);
    }}

    public static IEnumerable<{fullName}> LoadRecordsById(this MongoDbContextCollection<{fullName}> collection, params Guid[] ids)
    {{
        var filter = Builders<{fullName}>.Filter.AnyIn(""Id"", ids);
        return collection.LoadRecordsBy(filter);
    }}
    public static IEnumerable<{fullName}> LoadRecordsById(this MongoDbContextCollection<{fullName}> collection, IEnumerable<Guid[]> ids)
    {{
        var filter = Builders<{fullName}>.Filter.AnyIn(""Id"", ids);
        return collection.LoadRecordsBy(filter);
    }}
    public static Task<IEnumerable<{fullName}>> LoadRecordsByIdAsync(this MongoDbContextCollection<{fullName}> collection, params Guid[] ids)
    {{
        var filter = Builders<{fullName}>.Filter.AnyIn(""Id"", ids);
        return collection.LoadRecordsByAsync(filter);
    }}
    public static Task<IEnumerable<{fullName}>> LoadRecordsByIdAsync(this MongoDbContextCollection<{fullName}> collection, IEnumerable<Guid> ids)
    {{
        var filter = Builders<{fullName}>.Filter.AnyIn(""Id"", ids);
        return collection.LoadRecordsByAsync(filter);
    }}
    ...
    public static ReplaceOneResult? UpsertRecord(this MongoDbContextCollection<{fullName}> collection, Guid id, {fullName} record, ReplaceOptions? replaceOptions = null)
    {{
    ...
    public static Task<ReplaceOneResult?> UpsertRecordAsync(this MongoDbContextCollection<{fullName}> collection, Guid id, {fullName} record, ReplaceOptions? replaceOptions = null, CancellationToken cancellationToken = default)
    {{
        var binData = new BsonBinaryData(id, GuidRepresentation.Standard);
        var filter = new BsonDocument(""_id"", binData);
    ...
    public static DeleteResult? DeleteRecord(this MongoDbContextCollection<{fullName}> collection, Guid id)
    {{
        var filter = Builders<{fullName}>.Filter.Eq(""Id"", id);
        var result = collection.Collection.DeleteOne(filter);
        return result;
    }}
    public static Task<DeleteResult?> DeleteRecordAsync(this MongoDbContextCollection<{fullName}> collection, Guid id, CancellationToken cancellationToken = default)
    {{
        var filter = Builders<{fullName}>.Filter.Eq(""Id"", id);
...
internal record struct DataCollection(string ClassName, string Name, string Namespace);